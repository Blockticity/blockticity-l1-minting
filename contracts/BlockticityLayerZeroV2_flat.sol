...
abstract contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Errors {
    ...
    /**
     * @dev Returns the owner of `tokenId`. Does NOT revert if token doesn't exist
     *
     ...
     * a uint256 would be used to express a balance.
     */
     ...
     * (or `to`) is the zero address. Returns the owner of `tokenId` before the update.
     *
    ...
    /**
     * @dev Mints `tokenId`, transfers it to `to` and checks if `to` is a smart contract.
     * If `to` is a smart contract, it calls {IERC721Receiver-onERC721Received}, which requires
     * the recipient contract to implement this function to successfully receive ERC-721 transfers.
     *
     * Requirements:
     *
     * - `tokenId` must not exist.
    ...
    /**
     * @dev Reverts if the `tokenId` doesn't exist or is not owned by `owner`.
     */
...
/// @title EIP-4906: ERC-721 Metadata Update Extension
...
// File contracts/BlockticityLayerZeroV2.sol
